 ...
 */
function tuitiontool_admin_preprocess_maintenance_page(&$vars) {
  // While markup for normal pages is split into page.tpl.php and html.tpl.php,
  // the markup for the maintenance page is all in the single
  // maintenance-page.tpl.php template. So, to have what's done in
  // seven_preprocess_html() also happen on the maintenance page, it has to be
  // called here.
  tuitiontool_admin_preprocess_html($vars);
}

/**
 * Override or insert variables into the html template.
 */
function tuitiontool_admin_preprocess_html(&$vars) {
 ...
 */
function tuitiontool_admin_preprocess_page(&$vars) {
 ...
 */
function tuitiontool_admin_node_add_list($variables) {
 ...
 */
function tuitiontool_admin_admin_block_content($variables) {
  $content = $variables['content'];
  $output = '';
  if (!empty($content)) {
 ...
 */
function tuitiontool_admin_tablesort_indicator($variables) {
 ...
 */
function tuitiontool_admin_css_alter(&$css) {
...
function tuitiontool_admin_preprocess_form(&$vars){
  ...
  $aid_entries = array('american_aid_entry','bio_aid_entry','chem_aid_entry','coll_aid_entry','ees_aid_entry','english_aid_entry','epd_aid_entry','intdisc_aid_entry','history_aid_entry','math_aid_entry','misc_aid_entry','physics_aid_entry','polisci_aid_entry','psych_aid_entry','socanth_aid_entry');
    ...
    if(!empty($vars['element'])){
        if(!empty($vars['element']['#bundle'])){
            $bundle_name = $vars['element']['#bundle'];
            if(in_array($bundle_name,$aid_types)){
                $vars['element']['#attributes']['class'][] = 'general-aid-type-form';
            }
            elseif(in_array($bundle_name,$aid_entries)){
                $vars['element']['#attributes']['class'][] = 'general-aid-entry-form';
            }
        }
    }
}